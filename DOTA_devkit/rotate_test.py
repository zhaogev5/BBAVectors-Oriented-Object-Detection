...
def rotate_single_run(name, srcpath, dstpath):
    ...
    img = cv2.imread(os.path.join(src_imgpath, name + '.jpg'))
    ...
    with codecs.open(os.path.join(dst_labelTxt, name + '_90.txt'), 'w', 'utf_16') as f_out:
    ...
    with codecs.open(os.path.join(dst_labelTxt, name + '_180.txt'), 'w', 'utf_16') as f_out:
    ...
    with codecs.open(os.path.join(dst_labelTxt, name + '_270.txt'), 'w', 'utf_16') as f_out:
...
if __name__ == '__main__':
    start = time.clock()
    rotate(r'/home/dingjian/data/dota/val',
           r'/home/dingjian/data/dota/val_rote')
    elapsed = (time.clock() - start)
    print("Time used:", elapsed)

    start = time.clock()
    rotate(r'/home/dingjian/data/dota/val',
           r'/home/dingjian/data/dota/val_rote', 1)
    elapsed = (time.clock() - start)
    print("Time used:", elapsed)