...
def dota_task1_eval(work_dir, det_dir):
    ...
    # For DOTA-v1.5
    classnames = ['Dry-Cargo-Ship', 'Passenger-Ship', 'Fishing-Boat', 'Engineering-Ship', 'Motorboat', 'A220', 'Boeing737', 'Liquid-Cargo-Ship',\
...
def parse_args():
    ...
    parser.add_argument('--work_dir',default='work_dirs/ReDet_re50_refpn_1x_FAR')
    return parser.parse_args()

def main():
    args = parse_args()
    detpath = os.path.join(args.work_dir,'Task1_results_nms/Task1_{:s}.txt')
    annopath = r'../FAR_ori/test/labelTxt/{:s}.txt'
    imagesetfile = r'../FAR_ori/test/test.txt'
